    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                <li><a href="<c:url value="/groups/add"/>"><spring:message code="menu.groups.add"/></a></li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><spring:message
                            code="menu.contacts.title"/><b
                            class="caret"></b></a>
                    <ul class="dropdown-menu">
                        <li><a href="<c:url value="/contacts"/>"><spring:message
                                code="menu.contacts.list"/>
                        </a></li>
                        <li><a href="<c:url value="/contacts/add"/>"><spring:message
                                code="menu.contacts.add"/>
                        </a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><spring:message code="menu.language"/><b
                            class="caret"></b></a>
                    <ul class="dropdown-menu">
                        <li><a href="?language=en"><img src="<c:url value="/resources/image/en.png"/>"
                                                        alt=""/><spring:message
                                code="menu.language.english"/>
                        </a></li>
                        <li><a href="?language=ru"><img src="<c:url value="/resources/image/ru.png"/>"
                                                        alt=""/><spring:message
